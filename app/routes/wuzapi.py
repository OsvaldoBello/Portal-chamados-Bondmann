...
As duas rotas de webhook coexistem durante o corte (a da Meta continua
respondendo enquanto o número antigo estiver ativo) — quem decide qual está
valendo é `WHATSAPP_PROVIDER`, que esta rota checa antes de processar.
