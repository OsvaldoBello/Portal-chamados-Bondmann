...
e/ou uma seção "Texto extraído de documentos anexados" (PDF, Word, Excel ou
PowerPoint — laudo do cliente, por exemplo) — use como evidência
complementar quando presentes, sem presumir
